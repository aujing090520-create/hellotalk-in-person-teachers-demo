...
function renderProfileTab(teacher) {
  ...
  return `<section class="profile-tab-panel teacher-archive"><section class="teacher-types"><h3>教学类型</h3><div><span>FreeTalk</span><span>实用口语</span><span>旅行口语</span></div></section><section class="teacher-self-intro"><h3>老师自我介绍</h3><p>你好，我是 Sarah。在深圳开设一对一中文面授课，擅长把日常场景、旅行和工作沟通带入练习。我们可以先从你的学习目标聊起，再一起约定方便的上课地点。</p></section></section>`;
}
...
function renderProfile() {
  ...
  return `<div class="screen ht-profile map-profile"><main class="profile-scroll">${renderProfileVenueHero(teacher)}
    <section class="map-profile-summary"><div class="map-profile-avatar photo-${teacher.photo}"><i class="teacher-profile-mark">✦</i></div><div class="map-profile-name"><h1>${teacher.name} <span>♀24</span></h1><div class="map-profile-meta"><p class="map-profile-teaching">教学：中文</p><p class="map-profile-teacher"><i>✦</i>平台老师</p></div></div>${renderTeacherTrustStats()}</section>
