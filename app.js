...
function renderProfile() {
  ...
  return `<div class="screen ht-profile map-profile"><main class="profile-scroll">${renderProfileVenueHero(teacher)}
    <section class="map-profile-summary"><div class="map-profile-avatar teacher-credential-frame photo-${teacher.photo}"><svg class="teacher-credential-ring" viewBox="0 0 100 100" aria-hidden="true"><circle class="credential-ring-cyan" cx="50" cy="50" r="47"></circle><circle class="credential-ring-violet" cx="50" cy="50" r="40"></circle><defs><path id="teacher-credential-text" d="M50,8 a42,42 0 1,1 -0.1,0" /></defs><text><textPath href="#teacher-credential-text" startOffset="1%">CERTIFIED TEACHER · </textPath></text></svg><i class="teacher-cap" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="m3 9 9-5 9 5-9 5-9-5Z"/><path d="M6 11v4.5c3.4 2 8.6 2 12 0V11"/><path d="M20 10v5"/><circle cx="20" cy="16.5" r="1.2"/></svg></i><i class="profile-country-flag" aria-label="${teacher.country}">${flag(teacher.country)}</i></div><div class="map-profile-name"><h1>${teacher.name} <span>♀24</span></h1><div class="map-profile-meta"><p class="map-profile-teaching">教学：中文</p><p class="map-profile-teacher"><i>✦</i>平台老师</p></div></div>${renderTeacherTrustStats()}<i class="teacher-companion-watermark" aria-hidden="true"></i></section>${renderTeacherOverview(teacher)}
